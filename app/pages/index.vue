        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          <div class="group relative bg-white rounded-3xl overflow-hidden border border-slate-100 hover:border-[#FB325A]/30 transition-all duration-500 shadow-2xl shadow-slate-200/50 hover:shadow-[#FB325A]/10 h-[400px]">
            <div class="absolute inset-0 h-full w-full overflow-hidden">
              ...
              <img src="https://www.talonmc.net/content/images/size/w1500/2025/06/prison_A_Mine_Composited_signed.png" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="Prison" />
            </div>
          ...
          <div class="group relative bg-white rounded-3xl overflow-hidden border border-slate-100 hover:border-amber-400/50 transition-all duration-500 shadow-2xl shadow-slate-200/50 hover:shadow-amber-500/10 h-[400px] select-none">
            <div class="absolute inset-0 h-full w-full overflow-hidden">
              <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/20 to-transparent z-10"></div>
              <img src="https://static.wixstatic.com/media/76fe2d_c26fbbda06144ac39d611b127826a7ea~mv2.jpg/v1/fit/w_500,h_500,q_90/file.jpg" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 grayscale-[0.5] group-hover:grayscale-0" alt="Skyblock" />
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-10 items-center md:items-start">
              <div class="relative group flex-shrink-0">
                <div class="w-40 h-40 rounded-3xl bg-slate-50 border-2 border-slate-100 flex items-center justify-center overflow-hidden shadow-lg">
                  <img :src="`https://api.mineatar.io/body/full/${searchedPlayer.uuid}?scale=16`" class="h-[90%] object-contain drop-shadow-xl" alt="Player Skin" />
                </div>
          ...
          <div v-else class="divide-y divide-slate-100">
            ...
            >
              ...
              <div class="col-span-5 md:col-span-4 flex items-center gap-4">
                <div class="w-10 h-10 rounded-xl bg-slate-200 overflow-hidden ring-2 ring-transparent group-hover:ring-[#FB325A]/20 transition-all">
                  <img :src="`https://api.mineatar.io/face/${player.uuid}?scale=32`" class="w-full h-full grayscale group-hover:grayscale-0 transition-all duration-300" alt="face" />
                </div>
